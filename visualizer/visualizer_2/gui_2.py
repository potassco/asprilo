...
class MainWindow(QMainWindow):
    ...
    def __init__(self, sceneView, parent=None):
        ...
        self.save_to_png = QAction("Save Image", self)
        self.toggle_paths = QAction("Toggle Paths", self)
        ...
        self.save_to_png.triggered.connect(self._scene.save_to_png)
        self.toggle_paths.triggered.connect(self._scene.toggle_paths)
        self._createToolBar()
        self._createMenu()
    ...
    def _createToolBar(self):
        ...
        tools.addAction(self.save_to_png)
        tools.addAction(self.toggle_paths)
