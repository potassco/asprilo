...
* Key Characteristics of Instances (Default Problem Domain)
  ...
  our instance characteristics for the core problem, and later expand on those in connection with
...
* Classification of Instances
  ...
  #+BEGIN_SRC dot :file dot_classification.png :cmdline -Kdot -Tpng
    digraph {
...
*** Object-Types
    ...
    scope. For example, we determine the following object-types for the core problem:
...
** Instance (=./examples/core/instance.asp=)
   ...
   #+CAPTION: Visualization of instance =./examples/core/instance.asp=
   #+LABEL: fig:example-inst
   [[../examples/core/instance.png]]


** Possible Plan (=./examples/core/outcome.txt=)
